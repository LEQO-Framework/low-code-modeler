...
const UserCountPanel: React.FC<UserCountPanelProps> = ({ provider, roomName }) => {
  ...
  return (
    <div className="absolute bottom-4 left-1/2 transform -translate-x-[180px] bg-gray-900 text-white px-4 py-2 rounded-lg shadow-lg flex items-center space-x-4 z-50">
