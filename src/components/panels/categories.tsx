  ...
  [consts.dataTypes]: {
    ...
    content: {
      "Classical Datatypes": [
        ...
        { label: "Number", dataType: "float", type: consts.DataTypeNode, icon: "PaletteIcon_Float.png", description: "Integer value (whole number) or floating-point number (decimal).", completionGuaranteed: false, compactOptions: [true, false] },
