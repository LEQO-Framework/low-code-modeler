...
export const categories: Record<string, CategoryEntry> = {
  ...
  [consts.circuitLevelNodes]: {
    ...
    content: {
      ...
      "Circuit Blocks": [
        { label: "H", type: consts.GateNode, icon: "hadamard.png", description: "Hadamard gate: puts a qubit into superposition.", completionGuaranteed: true  },
        ...
        { label: "T", type: consts.GateNode, icon: "t.png", description: "T gate: a π/4 phase shift.", completionGuaranteed: true },
        { label: "X", type: consts.GateNode, icon: "pauliX.png", description: "Pauli-X gate: flips the state (like a NOT gate).", completionGuaranteed: true },
        { label: "Y", type: consts.GateNode, icon: "pauliY.png", description: "Pauli-Y gate: flips and phases the qubit state.", completionGuaranteed: true },
        { label: "Z", type: consts.GateNode, icon: "pauliZ.png", description: "Pauli-Z gate: adds a π phase shift to |1⟩ state.", completionGuaranteed: true },
        { label: "S", type: consts.GateNode, icon: "S_palette.png", description: "S gate: a π/2 phase shift.", completionGuaranteed: true },
        { label: "SX", type: consts.GateNode, icon: "SX_palette.png", description: "Square root of X gate (√X).", completionGuaranteed: true },
        { label: "SDG", type: consts.GateNode, icon: "SDG_palette.png", description: "S† gate: inverse of the S gate.", completionGuaranteed: true },
        { label: "TDG", type: consts.GateNode, icon: "TDG_palette.png", description: "T† gate: inverse of the T gate.", completionGuaranteed: true },
        { label: "P(λ)", type: consts.GateNode, icon: "P_palette.png", description: "Applies a phase λ to the |1⟩ state.", completionGuaranteed: true },
        { label: "CNOT", type: consts.GateNode, icon: "CNOT_palette.png", description: "Controlled-X gate: flips target qubit if control is |1⟩.", completionGuaranteed: true },
        ...
        { label: "CY", type: consts.GateNode, icon: "CY_palette.png", description: "Controlled-Y gate.", completionGuaranteed: true },
        { label: "CZ", type: consts.GateNode, icon: "CZ_palette.png", description: "Controlled-Z gate.", completionGuaranteed: true },
        { label: "CH", type: consts.GateNode, icon: "CH_palette.png", description: "Controlled-Hadamard gate.", completionGuaranteed: true },
        { label: "CP(λ)", type: consts.GateNode, icon: "CP_palette.png", description: "Controlled-Phase gate with phase λ.", completionGuaranteed: true },
        { label: "CRX(θ)", type: consts.GateNode, icon: "CRX_palette.png", description: "Controlled rotation by θ around X-axis.", completionGuaranteed: true },
        { label: "CRY(θ)", type: consts.GateNode, icon: "CRY_palette.png", description: "Controlled rotation by θ around Y-axis.", completionGuaranteed: true },
        { label: "CRZ(θ)", type: consts.GateNode, icon: "CRZ_palette.png", description: "Controlled rotation by θ around Z-axis.", completionGuaranteed: true },
        { label: "CU(θ,φ,λ,γ)", type: consts.GateNode, icon: "CU_palette.png", description: "Controlled universal unitary gate.", completionGuaranteed: false },
        { label: "Toffoli", type: consts.GateNode, icon: "Toffoli_palette.png", description: "CCNOT: flips target if both controls are |1⟩.", completionGuaranteed: true },
        { label: "CSWAP", type: consts.GateNode, icon: "CSWAP_palette.png", description: "Controlled SWAP: swaps two qubits if control is |1⟩.", completionGuaranteed: false },
