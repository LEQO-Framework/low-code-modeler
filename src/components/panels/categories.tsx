...
export const categories: Record<string, CategoryEntry> = {
  ...
  [consts.circuitLevelNodes]: {
    ...
    content: {
      ...
      "Circuit Blocks": [
        { label: "H", type: consts.GateNode, icon: "hadamard.png", description: "Hadamard gate: puts a qubit into superposition." },
        ...
        { label: "T", type: consts.GateNode, icon: "t.png", description: "T gate: a π/4 phase shift." },
        { label: "X", type: consts.GateNode, icon: "pauliX.png", description: "Pauli-X gate: flips the state (like a NOT gate)." },
        { label: "Y", type: consts.GateNode, icon: "pauliY.png", description: "Pauli-Y gate: flips and phases the qubit state." },
        { label: "Z", type: consts.GateNode, icon: "pauliZ.png", description: "Pauli-Z gate: adds a π phase shift to |1⟩ state." },
        { label: "S", type: consts.GateNode, icon: "S_palette.png", description: "S gate: a π/2 phase shift." },
        { label: "SX", type: consts.GateNode, icon: "SX_palette.png", description: "Square root of X gate (√X)." },
        { label: "SDG", type: consts.GateNode, icon: "SDG_palette.png", description: "S† gate: inverse of the S gate." },
        { label: "TDG", type: consts.GateNode, icon: "TDG_palette.png", description: "T† gate: inverse of the T gate." },
        { label: "P(λ)", type: consts.GateNode, icon: "P_palette.png", description: "Applies a phase λ to the |1⟩ state." },
        { label: "CNOT", type: consts.GateNode, icon: "CNOT_palette.png", description: "Controlled-X gate: flips target qubit if control is |1⟩." },
        { label: "SWAP", type: consts.GateNode, icon: "SWAP_palette.png", description: "Swaps the states of two qubits." },
        { label: "CY", type: consts.GateNode, icon: "CY_palette.png", description: "Controlled-Y gate." },
        { label: "CZ", type: consts.GateNode, icon: "CZ_palette.png", description: "Controlled-Z gate." },
        { label: "CH", type: consts.GateNode, icon: "CH_palette.png", description: "Controlled-Hadamard gate." },
        { label: "CP(λ)", type: consts.GateNode, icon: "CP_palette.png", description: "Controlled-Phase gate with phase λ." },
        { label: "CRX(θ)", type: consts.GateNode, icon: "CRX_palette.png", description: "Controlled rotation by θ around X-axis." },
        { label: "CRY(θ)", type: consts.GateNode, icon: "CRY_palette.png", description: "Controlled rotation by θ around Y-axis." },
        { label: "CRZ(θ)", type: consts.GateNode, icon: "CRZ_palette.png", description: "Controlled rotation by θ around Z-axis." },
        { label: "CU(θ,φ,λ,γ)", type: consts.GateNode, icon: "CU_palette.png", description: "Controlled universal unitary gate." },
        { label: "Toffoli", type: consts.GateNode, icon: "Toffoli_palette.png", description: "CCNOT: flips target if both controls are |1⟩." },
        { label: "CSWAP", type: consts.GateNode, icon: "CSWAP_palette.png", description: "Controlled SWAP: swaps two qubits if control is |1⟩." },
  ...
  [consts.dataTypes]: {
    ...
    content: {
      "Classical Datatypes": [
        ...
        { label: "string", dataType: "string", type: consts.DataTypeNode, icon: "basis_encoding_icon.png", description: "Text string value." },
        ...
        { label: "file", dataType: "file", type: consts.DataTypeNode, icon: "matrix_encoding_icon.png", description: "URL or file path to data (for ML plugin inputs)." },
      ],
      "Quantum Datatypes": [
