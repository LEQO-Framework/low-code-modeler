...
export const categories: Record<string, CategoryEntry> = {
  ...
  [consts.circuitLevelNodes]: {
    ...
    content: {
      ...
      "Circuit Blocks": [
        { label: "H", aliases: ["Hadamard"], type: consts.GateNode, icon: "hadamardBeginner.png", description: "Hadamard gate: puts a qubit into superposition.", completionGuaranteed: true, compactOptions: [true, false] },
        { label: "RX(θ)", type: consts.GateNode, icon: "RX_palette.png", description: "Rotates qubit around X-axis by θ radians.", completionGuaranteed: true, compactOptions: [true, false] },
        { label: "RY(θ)", type: consts.GateNode, icon: "RY_palette.png", description: "Rotates qubit around Y-axis by θ radians.", completionGuaranteed: true, compactOptions: [true, false] },
        { label: "RZ(θ)", type: consts.GateNode, icon: "RZ_palette.png", description: "Rotates qubit around Z-axis by θ radians.", completionGuaranteed: true, compactOptions: [true, false] },
        { label: "T", aliases: ["π/4 Phase"], type: consts.GateNode, icon: "t.png", description: "T gate: a π/4 phase shift.", completionGuaranteed: true, compactOptions: [true, false] },
        { label: "X", aliases: ["Pauli-X", "NOT"], type: consts.GateNode, icon: "pauliX.png", description: "Pauli-X gate: flips the state (like a NOT gate).", completionGuaranteed: true, compactOptions: [true, false] },
        { label: "Y", aliases: ["Pauli-Y"], type: consts.GateNode, icon: "pauliY.png", description: "Pauli-Y gate: flips and phases the qubit state.", completionGuaranteed: true, compactOptions: [true, false] },
        { label: "Z", aliases: ["Pauli-Z"], type: consts.GateNode, icon: "pauliZ.png", description: "Pauli-Z gate: adds a π phase shift to |1⟩ state.", completionGuaranteed: true, compactOptions: [true, false] },
        { label: "S", aliases: ["π/2 Phase"], type: consts.GateNode, icon: "S_palette.png", description: "S gate: a π/2 phase shift.", completionGuaranteed: true, compactOptions: [true, false] },
        { label: "SX", aliases: ["√X", "square root of X"], type: consts.GateNode, icon: "SX_palette.png", description: "Square root of X gate (√X).", completionGuaranteed: true, compactOptions: [true, false] },
        { label: "SDG", aliases: ["S†", "S-dagger"], type: consts.GateNode, icon: "SDG_palette.png", description: "S† gate: inverse of the S gate.", completionGuaranteed: true, compactOptions: [true, false] },
        { label: "TDG", aliases: ["T†", "T-dagger"], type: consts.GateNode, icon: "TDG_palette.png", description: "T† gate: inverse of the T gate.", completionGuaranteed: true, compactOptions: [true, false] },
        { label: "CNOT", aliases: ["Controlled-X"], type: consts.GateNode, icon: "CNOT_palette.png", description: "Controlled-X gate: flips target qubit if control is |1⟩.", completionGuaranteed: true, compactOptions: [true, false] },
        { label: "SWAP", type: consts.GateNode, icon: "SWAP_palette.png", description: "Swaps the states of two qubits.", completionGuaranteed: true, compactOptions: [true, false] },
        { label: "CY", aliases: ["Controlled-Y"], type: consts.GateNode, icon: "CY_palette.png", description: "Controlled-Y gate.", completionGuaranteed: true, compactOptions: [true, false] },
        { label: "CZ", aliases: ["Controlled-Z"], type: consts.GateNode, icon: "CZ_palette.png", description: "Controlled-Z gate.", completionGuaranteed: true, compactOptions: [true, false] },
        { label: "CH", aliases: ["Controlled-Hadamard"], type: consts.GateNode, icon: "CH_palette.png", description: "Controlled-Hadamard gate.", completionGuaranteed: true, compactOptions: [true, false] },
        { label: "CRX(θ)", aliases: ["Controlled-RX(θ)"], type: consts.GateNode, icon: "CRX_palette.png", description: "Controlled rotation by θ around X-axis.", completionGuaranteed: true, compactOptions: [true, false] },
        { label: "CRY(θ)", aliases: ["Controlled-RY(θ)"], type: consts.GateNode, icon: "CRY_palette.png", description: "Controlled rotation by θ around Y-axis.", completionGuaranteed: true, compactOptions: [true, false] },
        { label: "CRZ(θ)", aliases: ["Controlled-RZ(θ)"], type: consts.GateNode, icon: "CRZ_palette.png", description: "Controlled rotation by θ around Z-axis.", completionGuaranteed: true, compactOptions: [true, false] },
        { label: "Toffoli", aliases: ["CCNOT", "Controlled-Controlled-NOT"], type: consts.GateNode, icon: "Toffoli_palette.png", description: "CCNOT: flips target if both controls are |1⟩.", completionGuaranteed: true, compactOptions: [true, false] },
        { label: "CSWAP", aliases: ["Fredkin"], type: consts.GateNode, icon: "CSWAP_palette.png", description: "Controlled SWAP: swaps two qubits if control is |1⟩.", completionGuaranteed: true, compactOptions: [true, false] },
